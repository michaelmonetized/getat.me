...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Link in Bio for Consultants — Why You Need More Than Links",
    description: "Your bio link should book calls and collect payments, not just list URLs.",
    type: "article",
  ...
  return (
    <>
      ...
      <article className="prose prose-invert mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="lead">
          You&apos;re a consultant. Your Instagram bio is prime real estate. And you&apos;re wasting
          it on a list of links that goes nowhere.
        </p>

        <h2>The Problem With Generic Link-in-Bio Tools</h2>
        <p>
          Most link-in-bio tools were built for influencers sharing affiliate links. They give you a
          page of buttons. That&apos;s it. As a consultant, you need something fundamentally
          different:
        </p>
        <ul>
          <li>
            <strong>Booking</strong> — Let prospects schedule a discovery call without leaving your
            page
          </li>
          <li>
            <strong>Social proof</strong> — Show client reviews and testimonials right on your bio
            page
          </li>
          <li>
            <strong>Payments</strong> — Accept deposits, session fees, or retainers directly
          </li>
          <li>
        ...
        <ol>
          <li>
            <strong>Hero section</strong> — Your photo, one-line value prop, and a &quot;Book a
            Call&quot; button
          </li>
          <li>
          ...
          <li>
            <strong>Reviews</strong> — 3-5 client testimonials (collected automatically)
          </li>
          <li>
            <strong>About</strong> — Brief credentials and your story
          </li>
          <li>
            <strong>Links</strong> — Your podcast, newsletter, socials — the secondary stuff
          </li>
        </ol>

        <h2>How to Set This Up With GetAt.Me</h2>
        <p>GetAt.Me was built for exactly this use case. Here&apos;s the 5-minute setup:</p>
        <ol>
          <li>
            Sign up and claim your handle (e.g., <code>getat.me/yourname</code>)
          </li>
        ...
        <p>
          ...
          <strong>3-5x higher conversion rates</strong> compared to generic link-in-bio tools. Why?
          Because every element on the page is designed to build trust and reduce friction.
        </p>

        <h2>Stop Linking. Start Converting.</h2>
        <p>
          Your bio link is the most-clicked URL in your entire online presence. Make it count.
          Don&apos;t send people to a list of links — send them to a page that books calls, collects
          reviews, and grows your practice on autopilot.
        </p>

        <div className="mt-12 rounded-xl border border-neutral-800 bg-neutral-900 p-8 text-center">
          <p className="text-lg font-semibold">Build your consultant bio page in 5 minutes</p>
          <Link
            href="/register"
