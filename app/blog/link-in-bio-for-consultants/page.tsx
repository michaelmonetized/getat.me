  ...
  return (
    <>
      ...
      <article className="prose prose-invert mx-auto max-w-3xl px-6 py-16">
        ...
        <p>
          Think of it as a micro-website with one job: convert visitors into
          booked calls.
        </p>
        <ol>
          <li>
            <strong>Hero section</strong> — Your photo, one-line value prop, and
        ...
        <p>
          ...
          link-in-bio tools. Why? Because every element on the page is designed
        ...
        <p>
          ...
          Make it count. Don&apos;t send people to a list of links — send them
          to a page that books calls, collects reviews, and grows your practice
          on autopilot.
        </p>
