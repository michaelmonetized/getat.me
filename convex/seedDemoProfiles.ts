...
const profiles: DemoProfile[] = [
    ...
    sections: [
      {
        ...
        weight: 0,
        icon: "music",
        description: "Stream my music everywhere",
      },
      { name: "Merch & More", weight: 1, icon: "shopping-bag" },
    ],
    links: [
      {
        anchor: "Spotify — Neon Drift EP",
      ...
      {
        anchor: "YouTube — Official Videos",
  ...
  // ── 2. Consultant / Coach ───────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        weight: 0,
        icon: "calendar",
        description: "Coaching & consulting services",
      },
      {
        name: "Content",
        weight: 1,
        icon: "mic",
        description: "Podcast, articles & talks",
      },
    ...
    links: [
      ...
      {
        anchor: "Leadership Coaching (6-week)",
      ...
      {
        anchor: "Latest on Harvard Business Review",
        href: "https://hbr.org",
        weight: 3,
        color: "#1e293b",
        icon: "file-text",
    ...
    sections: [
      {
        ...
        weight: 0,
        icon: "utensils",
        description: "Get food or book a table",
      },
      { name: "Follow Us", weight: 1, icon: "heart" },
    ],
    links: [
      {
        anchor: "View Full Menu",
  ...
  // ── 4. Content Creator / Developer ──────────────────────────────
  {
    ...
    sections: [
      {
        ...
        weight: 0,
        icon: "play",
        description: "Streams, videos, and content",
      },
      {
        name: "Community",
        weight: 1,
    ...
    links: [
      {
        anchor: "YouTube — Tutorials & Vlogs",
        href: "https://youtube.com",
        weight: 0,
        color: "#FF0000",
        icon: "youtube",
      ...
      {
        anchor: "Discord Server (8k members)",
  ...
  // ── 5. Photographer ─────────────────────────────────────────────
  {
    ...
    links: [
      ...
      {
        anchor: "Print Shop — Limited Editions",
        href: "https://example.com/prints",
        weight: 3,
        color: "#171717",
        icon: "shopping-bag",
        sectionIndex: 1,
